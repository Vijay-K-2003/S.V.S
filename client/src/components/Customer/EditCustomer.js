...
const EditCustomer = () => {
  ...
  const handleEdit = (e) => {
    ...
    return toast.success("Updated Customer Successfully!", {
    ...
    <div className="component-full">
      <div className="container-edit-customer">
        <form className="edit-customer-form">
          ...
          <label className="eles eles-align" htmlFor="name">
            Name
          </label>
          <input
          ...
          />
          <p>{formErrors.name}</p>
          <label className="eles eles-align" htmlFor="mobileNumber">
            Mobile No.(Must include +91)
          </label>
          <input
            className="eles-in eles-align"
            type="tel"
          ...
          <label className="eles eles-align" htmlFor="area">
            Please select area where you live
          </label>
          <select
            className="eles-in eles-align"
            name="area"
          ...
          <input
            className="edit-customer-checkbox"
            type="checkbox"
            checked
            ...
            id="location"
          />
          <label className="eles" htmlFor="location">
            You are at location from where you want to be notified
          </label>
        ...
        <div className="edit-customer-image">
          <img
            className="edit-customer-theimage"
            alt="edit Customer"
            src={editCustomerImage}
          />
        </div>
      </div>
    </div>
